...
{
    public class SliteObjectFactory :
        IObjectFactory
    {
        private string StrCnn { get; set; }

        public SliteObjectFactory(
            string dataSource
            , string dataBase
            , string user
            , string password
        ...
        public SliteObjectFactory(string strCnn)
        {   
            if(strCnn.Contains("|"))
            {
        ...
        {
            return new SliteDataAdapter(this);
        }
